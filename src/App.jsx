...
const B={blue:"#2F9AFF",steel:"#7B97B2",graphite:"#334155",neon:"#3045E6",amethyst:"#8B47FF",sea:"#00C2B3",raspberry:"#FF4785",pumpkin:"#FF8C42",lilac:"#D875D6",bg:"#F5F8FB",white:"#fff",border:"#E5EAF0"};
const VC=[B.blue,B.neon,B.sea,B.amethyst,B.raspberry,B.pumpkin,B.lilac,B.steel,B.graphite,"#1ABC9C"];
...
const ICO=[IconNo,IconMid,IconYes];
const SM=[{v:0,l:"Нет",c:"#EF4444",bg:"#FEE2E2",d:"Не соответствует"},{v:1,l:"Частично",c:"#F59E0B",bg:"#FEF3C7",d:"Есть замечания"},{v:2,l:"Да",c:"#10B981",bg:"#D1FAE5",d:"Полностью ОК"}];
...
const WL={0:"Преимущество",1:"Требование",2:"Требование"};
const WC={0:{bg:"#DBEAFE",c:B.blue,bc:B.blue},1:{bg:"#FEE2E2",c:"#DC2626",bc:"#DC2626"},2:{bg:"#FEE2E2",c:"#DC2626",bc:"#DC2626"}};
