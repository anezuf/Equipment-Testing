  ...
  return <div className="view-section-pad" style={{maxWidth:920,margin:"0 auto",padding:"20px 16px"}}>
      ...
      <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:8,alignItems:"center"}}>
        ...
        <div style={{marginLeft:"auto",display:"flex",gap:6}}>
          ...
          <button className="btn-secondary" onClick={exportVendorForm} style={{padding:"6px 14px",borderRadius:10,border:`1.5px solid ${B.border}`,background:"#fff",color:B.steel,fontSize:11,fontWeight:600,cursor:"pointer",whiteSpace:"nowrap",display:"inline-flex",alignItems:"center",justifyContent:"center",gap:4}}>
      ...
      <div style={{display:"flex",justifyContent:"center",gap:12,padding:20}}>
        <button className="btn-primary" onClick={onNavigateDashboard} style={{padding:"10px 32px",borderRadius:20,border:"none",background:`linear-gradient(90deg,${B.blue},${B.neon})`,color:"#fff",fontSize:14,fontWeight:700,cursor:"pointer",boxShadow:`0 4px 16px ${B.blue}44`}}>Дашборд →</button>
      </div>
    </div>;
}
